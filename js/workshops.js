$(document).ready(function() {
   ...
   function convertToHtml(json_obj, head){
     ...
     $.each(json_obj.title, function(index, val){
         if(index % 3 == 0){
             str.push("<div class='col-xs-4 col-xs-offset-1 col-md-2 text-center workshop' data-toggle='modal' data-target='#workshopModal' data-key='"+ val +"' data-head='" + head + "' data-title='" + val + "'>");
         }else{
             str.push("<div class='col-xs-4 col-xs-offset-1 col-md-offset-2 col-md-2 text-center workshop' data-toggle='modal' data-target='#workshopModal' data-key='"+ val +"' data-head='" + head + "' data-title='" + val + "'>");
         }
         str.push("<div class='workshop-title text-center'>" + val + '</div>');
